...
``` bash
$ git clone git@github.com:your-name/symfony-json-body-parser-bundle.git
...
``` bash
$ git remote add upstream git@github.com:ThrusterIO/symfony-json-body-parser-bundle.git
